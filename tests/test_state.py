...
def test_save_creates_parent_dirs(tmp_path: Path) -> None:
    # Fresh root: the projects_root directory doesn't exist yet.
...
def test_path_layout_is_projects_root_session_id_json(tmp_path: Path) -> None:
    """State file lives directly at projects_root/<session-id>.json (no cwd subdir)."""
...
def test_global_sentinel_lives_outside_projects_dir(tmp_path: Path) -> None:
    ...
    p = _path_for("_global", tmp_path / "projects")
